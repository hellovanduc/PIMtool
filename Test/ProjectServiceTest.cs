...
//                new Group { NAME = "ABC", GROUP_LEADER = employees.ElementAt(0) }, null);
...
//        {
//            //  Act
//            var founded_groups = (List<Group>)projectService.FindAllGroups();

//            //  Assert
//            foreach (var group in groups)
//            {
//                Group founded_group = founded_groups.Find(p => p.ID == group.ID);
...
//        }
//        private void AreGroupsEqual(Group g1, Group g2)
//        {
...
//        private Project NewProject(int projectNumber, string name, string customer, DateTime startDate, Group group, ISet<Employee> employees)
//        {
//            return new Project
//            {
